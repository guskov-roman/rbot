...
class Bash(linux_shell.LinuxShell):
    ...
    def exec(
        ...
        with rbot.log.command(self.name, cmd) as ev:
            ...
            if cmd.startswith("sudo"):
                self.ch.attach_interactive(end_magic="\r\n", ctrld_exit=True)
    ...
    def run(
        ...
        def cmd_context(
            ...
            with contextlib.ExitStack() as cx:
                ev = cx.enter_context(rbot.log.command(self.name, cmd))
    ...
    def subshell(
        ...
        if args == ():
            ...
            cmd = self.escape(*args)
        rbot.log.command(self.name, cmd)
    ...
    def interactive(self) -> None:
        ...
        self.ch.sendline()
        rbot.log.message("Entering interactive shell ...")
