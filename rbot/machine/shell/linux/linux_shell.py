...
import rbot
import rbot.error
from rbot.machine.shell import shell
...
class LinuxShell(shell.Shell):
        ...
        **Example**:
        ...
        .. code-block:: python
            ...
            if lnx.test("which", "dropbear"):
                rbot.log.message("Dropbear is installed!")
    ...
    def env(
        ...
        **Example**:
        ...
        :param rbot.machine.linux.Path,\\ str value: Optional value to set the
            variable to.
        :rtype: str
    ...
    def run(
        ...
        :py:class:`~rbot.machine.linux.RunCommandProxy`.  **You must call one
        ...
        (see the methods of the :py:class:`~rbot.machine.channel.Channel` class).
        ...
        .. code-block:: python
            ...
            with lh.run("gdb", "-n", exe) as gdb:
                ...
                for line in local_info.split("\\n"):
                    ...
                    rbot.log.message(f"Local variable `{var}` has value `{val}`!")
    ...
    def subshell(
        ...
        .. warning::
            ...
            *rbot* expects the shell inside the subshell environment to be the
    ...
    def workdir(self: Self) -> path.Path[Self]:
        ...
        If configured properly, rbot will make sure this directory exists.
        Testcases should be able to deal with corrupt or missing files in this
        directory. Implementations should use :py:class:`rbot.machine.linux.Workdir`.
    ...
    @property
    def homedir(self: Self) -> path.Path[Self]:
        """
        Path to a $HOME directory.
        """

        return workdir.Workdir.athome(self, "")
