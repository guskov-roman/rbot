...
class Connector(machine.Machine):
    ...
    def from_context(
        ...
        """
        Create this machine from a rbot context.

        This method defines how rbot can automatically attempt creating this
    ...
    def clone(self: Self) -> Self:
        ...
        .. note::
            ...
            **Important**: You should **always** set the new machines ``_orig``
            ...
            that is ``None``, ``self``) so rbot knows these machines belong
            ...
            Not setting ``_orig`` means that rbot will treat the new and old
