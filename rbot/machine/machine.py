...
class Machine(abc.ABC):
    ...
    cases as :py:class:`~rbot.machine.connector.Connector` and
    :py:class:`~rbot.machine.shell.Shell` both inherit from it.
    """
    ...
    .. warning::
        ...
        write a :py:class:`~rbot.machine.shell.Shell` that wraps around the
...
class PreConnectInitializer(Machine):
    ...
    :py:meth:`rbot.machine.Initializer._init_machine`
    """
...
class PostShellInitializer(Machine):
    ...
    This initializer is run after :py:meth:`rbot.machine.Initializer._init_machine`
